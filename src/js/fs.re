...
[@bs.module "fs"]
external chown:
  (~path: string, ~uid: int, ~gid: int, unit => unit) => unit = "chown";
...
[@bs.module "fs"]
external copyFile:
  (~src: string, ~dest: string, ~flags: int, unit => unit) => unit = "copyFile";
...
[@bs.module "fs"]
external fchown:
  (~fd: fd, ~uid: int, ~gid: int, unit => unit) => unit = "fchown";
...
[@bs.module "fs"]
external futimes:
  (~fd: fd, ~atime: int, ~mtime: int, unit => unit) => unit = "futimes";
...
[@bs.module "fs"]
external lchown:
  (~path: string, ~uid: int, ~gid: int, unit => unit) => unit = "lchown";

[@bs.module "fs"]
external link:
  (~existingPath: string, ~newPath: string, unit => unit) => unit = "link";
...
[@bs.module "fs"]
external mkdtemp:
  (~prefix: string, ~options: string, (unit, string) => unit) => unit = "mkdir";

[@bs.module "fs"]
external open_:
  (~path: string, ~flags: string, ~mode: int, (unit, int) => unit) => unit =
    "open";
...
[@bs.module "fs"]
external readFile:
  (~path: string, ~options: string, (unit, string) => unit) => unit =
    "readFile";
...
[@bs.module "fs"]
external rename:
  (~oldPath: string, ~newPath: string, unit => unit) => unit = "rename";
...
[@bs.module "fs"]
external truncate:
  (~path: string, ~len: int, unit => unit) => unit = "truncate";
...
[@bs.module "fs"]
external utimes:
  (~path: string, ~atime: float, ~mtime: float, unit => unit) => unit =
    "utimes";
